...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageView.addTabListner(tabView);
        tabView.addPageListner(pageView);
        tabView.selected(t -> {
            if(t.getPosition() == 0) t.setIcon(R.drawable.dark_home);
            else if(t.getPosition() == 1) t.setIcon(R.drawable.dark_profile);
            else if(t.getPosition() == 2) t.setIcon(R.drawable.dark_prize);
            else t.setIcon(R.drawable.dark_setting);
        });
